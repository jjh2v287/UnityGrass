...
namespace GPUInstancer
{
    public static class GPUInstancerUtility
    {
...
#if GPUI_URP
                    if (GPUInstancerConstants.gpuiSettings.isURP && GraphicsSettings.renderPipelineAsset != null)
        ...
        private static string ReplaceShaderTextHLSLProgram(string includePath, string newShaderText, bool doubleEscape, bool forceAlphaTest = false)
        {
            // For SRP Shaders
            #region HLSLPROGRAM
            int lastIndex = 0;
        ...
        public static Shader CreateInstancedShader(Shader originalShader, bool useOriginal = false)
        {
            ...
            try
            {
                ...
                // For SRP Shaders
                newShaderText = ReplaceShaderTextHLSLProgram(includePath, newShaderText, false, originalShader.name == "Universal Render Pipeline/Nature/SpeedTree8");
