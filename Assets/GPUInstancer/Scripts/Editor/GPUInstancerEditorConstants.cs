...
namespace GPUInstancer
{
    ...
    {
        public static readonly string GPUI_VERSION = "GPU Instancer v1.7.4";
        public static readonly float GPUI_VERSION_NO = 1.74f;
        ...
        public static readonly string TEXT_terrainNormalEffect = "Terrain Normal Effect";
        ...
        public static readonly string TEXT_billboardNormalStrength = "Normal Strength";
        ...
        public static readonly string HELPTEXT_terrainNormalEffect = "\"Terrain Normal Effect\" goes from 0.0 to 1.0, with 1.0 the details will be aligned with the terrain normals, and lower numbers resulting in less rotation being applied.";
        ...
        public static readonly string HELPTEXT_boundsOffset = "\"Bounds Size Offset\" can be used to increase the bounding box size of the prototype. This will effect the culling and LOD calculations. It is useful for prototypes with shaders that modify vertex positions.";
        ...
        public static readonly string HELPTEXT_billboardNormalStrength = "Values lower than 1 will reduce and higher values will amplify the effect of the normals texture.";
        ...
        public static readonly string HELPTEXT_useCustomMaterialForTextureDetail = "\"Custom Material\" can be used to specify that a custom material will be used for a detail prototype instead of the default generated material that uses the \"GPUInstancer/Foliage\" shader. Note that Cross Quads are available for custom materials as well, but their ability to billboard at a distance will not be available since GPU Instancer handles billboarding in the \"GPUInstancer/Foliage\" shader.";
        ...
        public static readonly string HELPTEXT_detailDryColor = "\"Dry\" color of the Healthy/Dry noise variation for the prototypes that use the \"GPUInstancer/Foliage\" shader. This corresponds to the \"Dry Color\" property of the detail prototypes in the Unity terrain. The Healthy/Dry noise texture can be changed globally (terrain specific) for all detail prototypes that use the \"GPUInstancer/Foliage\" shader from the \"Healthy/Dry Noise Texture\" property above.";
        public static readonly string HELPTEXT_noiseSpread = "The \"Noise Spread\" property specifies the size of the \"Healthy\" and \"Dry\" patches for the Detail Prototypes that use the \"GPUInstancer/Foliage\" shader. This corresponds to the \"Noise Spread\" property of the detail prototypes in the Unity terrain. A higher number results in smaller patches. The Healthy/Dry noise texture can be changed globally for all detail prototypes that use the \"GPUInstancer/Foliage\" shader from the \"Healthy/Dry Noise Texture\" property above.";
        ...
        public static readonly string HELPTEXT_gradientPower = "\"GPUInstancer/Foliage\" shader provides an option to darken the lower regions of the mesh that uses it. This results in a more realistic look for foliage. You can set the amount of this darkening effect with the \"Gradient Power\" property, or turn it off completely by setting the slider to zero.";
        ...
        // Toolbar buttons
        [MenuItem("Tools/GPU Instancer/Add Prefab Manager", validate = false, priority = 111)]
        ...
        [MenuItem("Tools/GPU Instancer/Add Detail Manager For Terrains/Add as Separate GameObjects", validate = false, priority = 121)]
        public static void ToolbarAddDetailManagerDefault()
        {
        ...
        [MenuItem("Tools/GPU Instancer/Add Detail Manager For Terrains/Add Under Terrain GameObjects", validate = false, priority = 122)]
        public static void ToolbarAddDetailManagerToTerrains()
        {
            Terrain[] terrains = Terrain.activeTerrains;
            GameObject go = null;
            if (terrains != null && terrains.Length > 0)
        ...
        [MenuItem("Tools/GPU Instancer/Add Detail Manager For Terrains/Add as Separate GameObjects", validate = true)]
        public static bool ValidateToolbarAddDetailManagerDefault()
        {
            Terrain[] terrains = Terrain.activeTerrains;
            return terrains != null && terrains.Length > 0;
        }

        [MenuItem("Tools/GPU Instancer/Add Detail Manager For Terrains/Add Under Terrain GameObjects", validate = true)]
        public static bool ValidateToolbarAddDetailManagerToTerrains()
        {
            Terrain[] terrains = Terrain.activeTerrains;
            return terrains != null && terrains.Length > 0;
        }

        [MenuItem("Tools/GPU Instancer/Add Tree Manager For Terrains", validate = false, priority = 131)]
        ...
        [MenuItem("Tools/GPU Instancer/Show Prefab Replacer", validate = false, priority = 202)]
        public static void ToolbarShowPrefabReplacer()
        {
            GPUInstancerPrefabReplacerWindow.ShowWindow();
        }

        [MenuItem("Tools/GPU Instancer/Shaders/Clear Shader Bindings", validate = false, priority = 311)]
        ...
        [MenuItem("Tools/GPU Instancer/Shaders/Regenerate GPUI Shaders", validate = false, priority = 312)]
        ...
        [MenuItem("Tools/GPU Instancer/Shaders/Clear Shader Variants", validate = false, priority = 411)]
        ...
        [MenuItem("Tools/GPU Instancer/Shaders/Edit Shader Variants", validate = false, priority = 412)]
        ...
        [MenuItem("Tools/GPU Instancer/Reimport Packages", validate = false, priority = 501)]
        public static void ReimportPackages()
        {
            GPUInstancerDefines.ImportPackages(true);
        }

        [MenuItem("Tools/GPU Instancer/Help/Getting Started", validate = false, priority = 801)]
        public static void OpenGettingStarted()
        {
            Application.OpenURL("https://wiki.gurbu.com/index.php?title=GPU_Instancer:GettingStarted");
        }

        [MenuItem("Tools/GPU Instancer/Help/Best Practices", validate = false, priority = 802)]
        public static void OpenBestPractices()
        {
            Application.OpenURL("https://wiki.gurbu.com/index.php?title=GPU_Instancer:BestPractices");
        }

        [MenuItem("Tools/GPU Instancer/Help/Terminology", validate = false, priority = 803)]
        public static void OpenTerminology()
        {
            Application.OpenURL("https://wiki.gurbu.com/index.php?title=GPU_Instancer:Terminology");
        }

        [MenuItem("Tools/GPU Instancer/Help/Change Log", validate = false, priority = 811)]
        public static void OpenChangeLog()
        {
            Application.OpenURL("https://gurbu.com/changelog");
        }

        [MenuItem("Tools/GPU Instancer/Help/Troubleshooting", validate = false, priority = 901)]
        public static void OpenTroubleshooting()
        {
            Application.OpenURL("https://wiki.gurbu.com/index.php?title=GPU_Instancer:FAQ#Troubleshooting");
        }

        [MenuItem("Tools/GPU Instancer/Help/Support Request", validate = false, priority = 902)]
        public static void RequestSupport()
        {
            Application.OpenURL("https://wiki.gurbu.com/index.php?title=GPU_Instancer:FAQ#How_can_I_make_a_Support_Request.3F");
        }

#if UNITY_2021_2_8 || UNITY_2021_2_9 || UNITY_2021_2_10 || UNITY_2021_2_11
        [MenuItem("Tools/GPU Instancer/Help/Unity 2021.2.8-11 Shader Bug Fix", validate = false, priority = 991)]
        public static void ModifyGeneratedShaders()
        {
            if (EditorUtility.DisplayDialog("Temp Unity 2021.2.8-11 Bug Fix", "This operation will modify GPUI auto generated shaders to compensate for the Unity 2021.2.8 Shader Bug.\n\nDo you wish to continue?",
                       "Yes", "No"))
            {
                foreach (ShaderInstance si in GPUInstancerConstants.gpuiSettings.shaderBindings.shaderInstances)
                {
                    if (!si.isOriginalInstanced)
                    {
                        string originalAssetPath = AssetDatabase.GetAssetPath(si.instancedShader);
                        string shaderText = File.ReadAllText(originalAssetPath);
                        string newShaderText = shaderText.Replace("#pragma multi_compile _ PROCEDURAL_INSTANCING_ON", "").Replace("HLSLPROGRAM", "HLSLPROGRAM\n#pragma multi_compile _ PROCEDURAL_INSTANCING_ON").Replace("#pragma multi_compile_instancing", "");
                        byte[] bytes = System.Text.Encoding.UTF8.GetBytes(newShaderText);

                        FileStream fs = File.Create(originalAssetPath);
                        fs.Write(bytes, 0, bytes.Length);
                        fs.Close();
                        AssetDatabase.ImportAsset(originalAssetPath, ImportAssetOptions.ForceUpdate);
                    }
                }
            }
        }
