...
public class GrassComputeScript : MonoBehaviour
{
    ...
    [Header("FrustumCurling Angle")]
    public float angleCurling = 0.65f;
    ...
    private void SetGrassDataBase()
    {
        ...
        m_InstantiatedComputeShader.SetFloat("_Angle", angleCurling);
    }
    ...
    private void SetGrassDataUpdate()
    {
        ...
        if (Application.isPlaying && m_MainCamera != null)
        {
            ...
            Matrix4x4 projMat = GL.GetGPUProjectionMatrix(m_MainCamera.projectionMatrix, false);
            Matrix4x4 _VP = projMat * m_MainCamera.worldToCameraMatrix;

            Matrix4x4 v = m_MainCamera.worldToCameraMatrix;
            Matrix4x4 p = m_MainCamera.projectionMatrix;
            Matrix4x4 _MVP = p * v;

            m_InstantiatedComputeShader.SetMatrix("_VP_MATRIX", _MVP);
        ...
        else if (view != null)
        {
            ...
            Matrix4x4 v = view.camera.worldToCameraMatrix;
            Matrix4x4 p = view.camera.projectionMatrix;
            Matrix4x4 _MVP = p * v;
